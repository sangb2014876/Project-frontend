<template>
  <div class="container ">
    <h2 class="text-2lx font-semibold text-center mt-4">upload an image to cloudinary</h2>
    <div class="grid md:grid-cols-6 grid-cols-1">
      <div class="md:col-start-2 md:col-span-4 shadow-lg">
        <div class="grid md:grid-cols-2 grid-cols-1">
          <div class="blog p-6 rounded-lg bg-white max-w-sm mt4">
            <form >
          ...
          <div class="p-4">
            ...
            <img v-if="filePreview" class="bg-white p-1 border rounded" :src="filePreview">
...
//Format image sixe to hunman-realable unit
